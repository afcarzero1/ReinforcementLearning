...
def point_e(weights_path , folder):
    ...
    analyze_parameter("lambda_sarsa", [0.1, 0.2, 0.5, 0.7, 0.9],weights_path ,folder)
    analyze_parameter("momentum", [0.1, 0.2, 0.5, 0.7, 0.9], weights_path,folder)
...
def main():
    ...
    test_different_exploration(wights_file,results_folder)

    analyze_learning_rate(wights_file, results_folder)
    analyze_parameter("lambda_sarsa", [0.1, 0.2, 0.5, 0.7, 0.9],wights_file ,results_folder)
    analyze_parameter("momentum", [0.1, 0.2, 0.5, 0.7, 0.9], wights_file,results_folder)

    compare_plots_rewards("eta",[define_eta("increase_comb"),define_eta("full")],wights_file ,results_folder)
